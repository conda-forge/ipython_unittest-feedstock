About ipython_unittest-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipython_unittest-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4837&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipython_unittest-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipython_unittest` can be installed with `conda`:
...
```
mamba install ipython_unittest
```

It is possible to list all of the versions of `ipython_unittest` available on your platform with `conda`:
...
```
mamba search ipython_unittest --channel conda-forge
```
...
mamba repoquery search ipython_unittest --channel conda-forge

# List packages depending on `ipython_unittest`:
mamba repoquery whoneeds ipython_unittest --channel conda-forge

# List dependencies of `ipython_unittest`:
mamba repoquery depends ipython_unittest --channel conda-forge
```
